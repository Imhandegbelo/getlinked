...
const Footer = () => {
  return (
    <footer className="text-white bg-slate-950 py-4 sm:py-8 md:py-12 px-10 sm:px-12 md:px-16 lg:px-32">
      <div className="flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-10 justify-between">
        <div className="flex flex-col md:flex-row justify-between  w-full md:w-3/5 gap-4 sm:gap-6 md:gap-10">
          <div className="">
            <div>
              ...
              <p className="text-xs mb-4">
                Getlinked Tech Hackaton is a technology innovation program
          ...
          <div className="flex flex-col text-xs">
            <h3 className="text-[#D434FE] text-sm">Useful Links</h3>
        ...
        <div className="flex flex-col gap-2">
          <h3 className="text-[#D434FE] text-sm">Contact Us</h3>
