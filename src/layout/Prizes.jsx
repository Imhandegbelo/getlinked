  ...
  return (
    ...
    >
      <div className="flex flex justify-between align-right mb-24">
        ...
        <div className="text-center md:text-left w-fit relative">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="w-full md:w-1/2 relative">
          ...
          <img
            src={star_w}
            alt="white twinkling star"
            className="absolute left-[8%] -top-20 animate-[pulse_2s_infinite]"
          />
          <img
            src={star_g}
          ...
          <img
            src={star_w}
            alt="white twinkling star"
            className="absolute  -right-16 top-0 animate-[pulse_3s_infinite]"
          />
        </div>
      </div>
    </section>
