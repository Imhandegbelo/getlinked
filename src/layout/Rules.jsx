  ...
  return (
    ...
    >
      <div className="w-full text-center md:text-left relative">
        <h3 className="font-clash+display text-xl md:text-2xl lg:text-3xl font-bold mb-3 lg:mb-6">
        ...
        src={star_w}
        alt="twinkling star"
        className="w-4 h-5 md:hidden animate-[ping_1s_infinite] bottom-10 right-1/2 absolute"
      /> */}
      </div>
      <div className="w-full order-first md:order-last relative">
        <img
          src={photo_rules}
        ...
        src={star_w}
        alt="twinkling star"
        className="w-4 h-5 animate-pulse bottom-36 left-0 absolute"
      />
      </div>
      {/* twinkling stars */}
      <img
        src={star_g}
        alt="twinkling star"
        className="w-4 h-5 lg:w-5 lg:h-6 animate-[ping_1s_infinite] bottom-2/5 left-[] absolute"
      />
      <img
        src={star_w}
        alt="twinkling star"
        className="w-4 h-5 lg:w-5 lg:h-6 animate-[ping_1s_infinite] bottom-10 right-1/2 absolute"
      />
    </section>
  );
}
