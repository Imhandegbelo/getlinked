    ...
    return (
      <div className="w-full">
        <input
          ...
          type="text"
          name={name}
          className="text-base p-2 md:p-4 border border-white rounded w-full bg-transparent placeholder-white"
  ...
  return (
    <div className="flex flex-col p-6 max-w-[1440px] mx-auto items-center text-white lg:py-12 lg:px-36">
      <div className="flex flex-col md:gap-4 w-full order-2 md:order-1 items-center">
        ...
        <p className="text-base hidden md:block">Call Us : 07067981819</p>
        <p className="text-base hidden md:block">
      ...
      <div className="w-full rounded-md p-8 order-1 md:order-2 bg-transparent md:bg-purple-900/10 md:p-14 md:shadow-md">
        <p className="text-xl text-[#D434FE] font-semibold">
          ...
          <div className="p-px mx-auto rounded bg-gradient-to-r w-fit from-[#903AFF] via-[#D434FE] via[#FF26B9] to-[#FE34B9]">
            <div className="rounded bg-slate-800">
              <button
                ...
                className={`py-3 px-4 transition transition-all font-bold bg-gradient-to-r from-[#903AFF] via-[#D434FE] via[#FF26B9] to-[#FE34B9] hover:bg-none`}
              >
                Register Now
              </button>
            </div>
